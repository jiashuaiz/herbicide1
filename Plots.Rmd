...
The plots show herbicide resistance of "Clethodim", "Glyphosate", "Sulfometuron", and "Terbuthylazine".
You can see your situation compared to other neighbours; wherein the highlighted lines indicate where you are.
```{r, Histograms}
par(mfrow=c(2,2))
