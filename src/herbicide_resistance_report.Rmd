...
LAYOUT = matrix(c(rep(1, l1*((2*r)+rl)),
                  ...
                  rep(6, l4*((2*r)+rl))), nrow=l1+l2+l3+l4, byrow=TRUE)
layout(LAYOUT)
par(cex=1.15)
...
for (i in 1:length(list_herbicides)){
  ...
  ### title
  plot_herbicide_name(name_herbicide, colour_herbicide, cex.title=1.5)
  ### histogram
  vec_percentiles = plot_hist(vec_resistance, name_herbicide, colour_herbicide, df_farmer)
  ### population names
  plot_legend(vec_percentiles, colour_herbicide, cex.text=0.8)
  ### heat map
  color_gradient = plot_heatmap(name_herbicide, df_farmer)
  ### heat map legend
  plot_heatmap_legend(color_gradient)
  ### description
  plot_description(name_herbicide, colour_herbicide, df_herbi_specs, df_farmer, cex.text=1, width=75)
}
```
