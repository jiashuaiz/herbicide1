...
- The percentile scores indicate how many populations have resistance levels less than or equal to your populations. For example, 42nd percentile means that 42% of the populations we tested have resistance levels less than or equal to your population.
...
plot_heatmap_legend = function(color_gradient){
  ...
  mtext("Susceptible", side=1, line=0.5, at=0.5, cex=0.75)
}
# plot_heatmap_legend(color_gradient)
```

```{r, echo=FALSE}
### Herbicide and assay description
plot_description = function(name_herbicide, colour_herbicide, df_herbi_specs, df_farmer, cex.text=1, width=75){
  ...
  DESCRIPTION = c(paste(strwrap(paste0(name_herbicide, " is a ", pre_or_post, " herbicide. It belongs to group ", au_group, " (equivalent to HRAC group ", hrac_group, 
                                       "). We used ", commercial_name, " at ", application_rate, " g active ingredient per hectare."), width=width), collapse="\n"),
  ...
  if (nrow(df_farmer)==1){
    DESCRIPTION[2] = sub("The sample sizes of your populations were:", "The sample size of your population was:", DESCRIPTION[2])
  }
