...
### Histograms:
```{r}
par(mfrow=c(2,2), cex=1, mar=c(5,2,3,2))
for (name_herbicide in list_herbicides){
  ...
  if (sum(!is.na(subdat_resistance))==0){
    ...
    # plot(density(resistance, adjust=1), main="", xab=name_herbicide)
...
for (herbicide in c("Clethodim", "Glyphosate", "Sulfometuron", "Terbuthylazine")){
  ...
  landscape_gradient = readRDS(paste0("../res/landscape_surfaces_gradient_data_", herbicide, ".rds"))
